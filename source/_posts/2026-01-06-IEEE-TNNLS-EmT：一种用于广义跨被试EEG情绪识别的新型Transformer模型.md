...
{% asset_img 2.webp %}
<div align='center'>图1 EmT的网络结构</div>
...
<div align='center'>表1 EmT变体的详细信息</div>
{% asset_img 3.webp %}
...
<div align='center'>表2 不同方法在SEED、THU-EP和FACED数据集上的跨被试（generalized）情绪分类结果</div>
{% asset_img 4.webp %}
...
<div align='center'>表3 不同方法在 MAHNOB-HCI 数据集上的情绪回归结果</div>
{% asset_img 5.webp %}
...
<div align='center'>表4 EmT消融实验结果</div>
{% asset_img 6.webp %}
...
{% asset_img 7.webp %}
<div align='center'>图2 特征类型对 EmT 情感分类和回归性能的影响</div>
...
{% asset_img 8.webp %}
<div align='center'>图3 TCT块数量对情绪分类和回归性能的影响</div>
...
> <https://www.scholat.com/teamwork/showPostMessage.html?id=17722>
